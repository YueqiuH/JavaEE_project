...
--
-- 计算机与人工智能学院（dept_id=1，原有5人，补充3人，+1停用）
--
...
--
-- 经济管理学院（dept_id=2，原有3人，补充5人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 机械工程学院（dept_id=4，原有1人，补充7人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 艺术设计学院（dept_id=6，原有1人，补充7人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 土木工程学院（dept_id=17，无原有，补充9人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 电子信息学院（dept_id=18，无原有，补充9人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 化学化工学院（dept_id=19，无原有，补充8人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 生命科学学院（dept_id=20，无原有，补充8人，无停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
...
--
-- 新闻传播学院（dept_id=22，无原有，补充8人，+1停用）
--
INSERT INTO `user` (`username`, `password`, `user_type`, `real_name`, `gender`, `phone`, `email`, `title`, `position`, `dept_id`, `status`) VALUES
