...
export const services = [
  { key: 'course-schedule', routeName: 'courseSchedule', title: '排课与课表', description: '查看课程安排、教室与调课信息', domain: 'teaching', icon: 'Calendar', template: 'schedule', summary: '今日 4 节课程', status: '今日' },
  { key: 'course-selection', routeName: 'courseSelection', title: '选课与容量', description: '课程检索、容量控制与选课办理', domain: 'teaching', icon: 'Select', template: 'transaction', summary: '第二轮选课进行中', status: '开放中' },
  { key: 'score-management', routeName: 'scoreManagement', title: '成绩评定与预警', description: '成绩录入、绩点计算与学业预警', domain: 'teaching', icon: 'TrendCharts', template: 'table', summary: '8 条待关注预警', status: '待处理' },
  { key: 'exam-arrangement', routeName: 'examArrangement', title: '考试与补考', description: '考试安排、监考与补考报名', domain: 'teaching', icon: 'Tickets', template: 'schedule', summary: '下场考试 7月18日', status: '临近' },
  { key: 'graduation-design', routeName: 'graduationDesign', title: '毕业设计管理', description: '选题、中期检查与答辩全过程', domain: 'teaching', icon: 'Collection', template: 'approval', summary: '3 项材料待审核', status: '待办' },
  { key: 'ai-learning', routeName: 'aiLearning', title: 'AI 智能学习助理', description: '材料总结、复习题与学习路径建议', domain: 'teaching', icon: 'MagicStick', template: 'ai', summary: '基于课程材料智能辅学', status: '演示模式', ai: true },
  ...
  { key: 'fee-payment', routeName: 'feePayment', title: '学杂费交纳', description: '账单查询、在线缴费与流水查看', domain: 'office', icon: 'Wallet', template: 'transaction', summary: '当前无待缴账单', status: '已完成', permissions: ['fee:self:read'] },
  { key: 'asset-management', routeName: 'assetManagement', title: '固定资产管理', description: '资产台账、申领、盘点与处置', domain: 'office', icon: 'Box', template: 'table', summary: '5 项资产待盘点', status: '待处理', permissions: ['asset:read'] },
  { key: 'work-plan', routeName: 'workPlan', title: '工作计划', description: '计划制定、任务协同与进度跟踪', domain: 'office', icon: 'Checked', template: 'schedule', summary: '今日 3 项任务', status: '进行中', permissions: ['work-plan:self', 'work-plan:manage'] },
  { key: 'document-oa', routeName: 'documentOA', title: '公文流转 OA', description: '收发文、会签、审批与催办', domain: 'office', icon: 'Document', template: 'approval', summary: '4 份公文待处理', status: '待办', permissions: ['document:self', 'document:approve'] },
  ...
  { key: 'ai-approval', routeName: 'aiApproval', title: 'AI 审批助手', description: '公文摘要、要点提取与意见草稿', domain: 'office', icon: 'MagicStick', template: 'ai', summary: '为审批工作提供智能建议', status: '演示模式', ai: true, permissions: ['ai-approval:use'] },
  ...
  { key: 'department-major', routeName: 'departmentMajor', title: '院系专业管理', description: '院系、专业与培养资源维护', domain: 'base', icon: 'Management', template: 'table', summary: '18 个院系 · 64 个专业', status: '已同步' },
  { key: 'news-forum', routeName: 'newsForum', title: '新闻与论坛', description: '新闻公告发布与校园交流', domain: 'base', icon: 'ChatDotSquare', template: 'table', summary: '7 条内容待审核', status: '待处理' },
  { key: 'ai-report', routeName: 'aiReport', title: 'AI 智能报表', description: '自然语言查询与图表生成', domain: 'base', icon: 'DataLine', template: 'ai', summary: '用自然语言探索校园数据', status: '演示模式', ai: true },
]
