...
export const services = [
  ...
  { key: 'lab-booking', routeName: 'labBooking', title: '实验室预约', description: '实验室、工位与设备预约', domain: 'student', icon: 'OfficeBuilding', template: 'schedule', summary: '今日剩余 12 个时段', status: '可预约', roles: [1,3,4] },
